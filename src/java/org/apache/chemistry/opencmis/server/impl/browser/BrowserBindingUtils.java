...
public class BrowserBindingUtils
{
    ...
    public static Properties createProperties( ControlParser controlParser, String typeId, TypeCache typeCache )
    {
        ...
        Map<Integer, Map<Integer, String>> multiValuePropertyMap = controlParser.getTwoDimMap( Constants.CONTROL_PROP_VALUE );
    ...
    public static Acl createAddAcl( ControlParser controlParser )
    {
        ...
        for ( String principalId : principals )
        {
            aces.add( new AccessControlEntryImpl( new AccessControlPrincipalDataImpl( principalId ),
                    controlParser.getValues( Constants.CONTROL_ADD_ACE_PERMISSION, i ) ) );
            i++;
        }
    ...
    public static Acl createRemoveAcl( ControlParser controlParser )
    {
        ...
        {
            aces.add( new AccessControlEntryImpl( new AccessControlPrincipalDataImpl( principalId ),
                    controlParser.getValues( Constants.CONTROL_REMOVE_ACE_PERMISSION, i ) ) );
            i++;
        }
    ...
    public static void writeEmpty( HttpServletRequest request, HttpServletResponse response )
        throws IOException
    {
        response.setContentLength( 0 );
