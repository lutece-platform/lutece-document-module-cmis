...
public class ObjectService extends AbstractService implements ObjectServicePort
{
    ...
    public void createDocumentFromSource( String repositoryId, String sourceId, CmisPropertiesType properties,
        String folderId, EnumVersioningState versioningState, List<String> policies, CmisAccessControlListType addAces,
        CmisAccessControlListType removeAces, Holder<CmisExtensionType> extension, Holder<String> objectId )
        ...
        Holder<String> objectId ) throws CmisException
    {
        ...
        try
        {
            ...
            String id = service.createRelationship( repositoryId, convert( properties ), policies,
                    convert( addAces, null ), convert( removeAces, null ), extData );
