...
public final class ObjectService
{
        ...
        throws Exception
    {
        ...
        if ( objectId == null )
        {
            ...
            newObjectId = service.create( repositoryId, parser.getProperties(  ), folderId,
                    parser.getContentStream(  ), versioningState, parser.getPolicyIds(  ), null );
        }
        else
        {
        ...
        HttpServletRequest request, HttpServletResponse response )
    {
        ...
        // execute
        service.deleteContentStream( repositoryId, new Holder<String>( objectId ),
        ...
        throws Exception
    {
        ...
        // execute
        Holder<String> objectIdHolder = new Holder<String>( objectId );
        service.setContentStream( repositoryId, objectIdHolder, overwriteFlag,
        ...
        throws Exception
    {
        ...
        if ( ( checkin != null ) && ( checkin.booleanValue(  ) ) )
        {
            service.checkIn( repositoryId, objectIdHolder, major, parser.getProperties(  ),
                parser.getContentStream(  ), checkinComment, parser.getPolicyIds(  ), null, null, null );
        }
        else
        {
            ...
            service.updateProperties( repositoryId, objectIdHolder,
                ( changeToken == null ) ? null : new Holder<String>( changeToken ), parser.getProperties(  ), null );
        }
