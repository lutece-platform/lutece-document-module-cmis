...
public class AtomEntryParser
{
     ...
     */
    public AtomEntryParser( InputStream stream, File tempDir, int memoryThreshold )
        throws Exception
    {
    ...
    private void parseEntry( XMLStreamReader parser ) throws Exception
    {
        ...
        if ( ( object != null ) && ( object.getProperties(  ) != null ) && ( atomTitle != null ) &&
                ( atomTitle.length(  ) > 0 ) )
        {
     ...
     */
    private void parseObject( XMLStreamReader parser )
        throws Exception
    {
     ...
     */
    private void parseAtomContent( XMLStreamReader parser )
        throws Exception
    {
     ...
     * Extract the content stream.
     */
    private void parseCmisContent( XMLStreamReader parser )
        throws Exception
    {
     ...
     */
    private static String readText( XMLStreamReader parser )
        throws Exception
    {
     ...
     */
    private ThresholdOutputStream readBase64( XMLStreamReader parser )
        throws Exception
    {
     ...
     */
    private static byte[] copy( XMLStreamReader parser )
        throws Exception
    {
        // create a writer
     ...
     */
    private static void skip( XMLStreamReader parser )
        throws Exception
    {
        int level = 1;
    ...
    private static boolean next( XMLStreamReader parser )
        throws Exception
    {
        if ( parser.hasNext(  ) )
        {
